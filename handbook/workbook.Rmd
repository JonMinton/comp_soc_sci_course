...
* And as before, work through the code chunks, and for each code chunk
    ...
    * Reflect on the substantive findings from running the chunk
    * Run the code chunk component by component, first making predictions about the effect you expect the component to have on the output, then comparing your prediction with the actual output. 
