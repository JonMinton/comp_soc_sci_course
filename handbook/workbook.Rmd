...
Welcome to a one day course on computational social science in R. This course will provide some examples of automating processes involving (fairly) large amounts of data, which we’ll run and discuss over the course of the day. 
